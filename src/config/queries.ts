...
export const QUERIES_BY_TIER: Record<number, string[]> = {
  ...
  1: [
    ...
    'óptica Doneztebe', 'taller mecánico Doneztebe', 'farmacia Doneztebe',
    'óptica Santesteban', 'taller mecánico Santesteban', 'farmacia Santesteban',
    'óptica Igantzi', 'taller mecánico Igantzi', 'farmacia Igantzi',
    'óptica Etxalar', 'taller mecánico Etxalar', 'farmacia Etxalar',
    'óptica Arantza', 'taller mecánico Arantza', 'farmacia Arantza',
  ...
  2: [
    ...
    'óptica Hondarribia', 'taller mecánico Hondarribia', 'farmacia Hondarribia',
    'óptica Ordizia', 'taller mecánico Ordizia', 'farmacia Ordizia',
    'óptica Lazkao', 'taller mecánico Lazkao', 'farmacia Lazkao',
    'óptica Legazpi', 'taller mecánico Legazpi', 'farmacia Legazpi',
    'óptica Oñati', 'taller mecánico Oñati', 'farmacia Oñati',
    'óptica Bergara', 'taller mecánico Bergara', 'farmacia Bergara',
    'óptica Arrasate', 'taller mecánico Arrasate', 'farmacia Arrasate',
    'óptica Soraluze', 'taller mecánico Soraluze', 'farmacia Soraluze',
    'óptica Elgoibar', 'taller mecánico Elgoibar', 'farmacia Elgoibar',
    'óptica Deba', 'taller mecánico Deba', 'farmacia Deba',
    'óptica Zumaia', 'taller mecánico Zumaia', 'farmacia Zumaia',
    'óptica Getaria', 'taller mecánico Getaria', 'farmacia Getaria',
    'óptica Orio', 'taller mecánico Orio', 'farmacia Orio',
  ...
  3: [
    ...
    'óptica Erandio', 'taller mecánico Erandio', 'farmacia Erandio',
    'óptica Sopela', 'taller mecánico Sopela', 'farmacia Sopela',
    'óptica Mungia', 'taller mecánico Mungia', 'farmacia Mungia',
    'óptica Galdakao', 'taller mecánico Galdakao', 'farmacia Galdakao',
    'óptica Amorebieta', 'taller mecánico Amorebieta', 'farmacia Amorebieta',
    'óptica Bermeo', 'taller mecánico Bermeo', 'farmacia Bermeo',
    'óptica Gernika', 'taller mecánico Gernika', 'farmacia Gernika',
    'óptica Ermua', 'taller mecánico Ermua', 'farmacia Ermua',
    'óptica Santurtzi', 'taller mecánico Santurtzi', 'farmacia Santurtzi',
    'óptica Arrigorriaga', 'taller mecánico Arrigorriaga', 'farmacia Arrigorriaga',
  ],
